...
for number in re.finditer('\d+', sstring):

    existing_neighbours = []

    current_num_index = number.start()
    all_possible_neighbour_indices = [current_num_index - 1, current_num_index + len(number.group())]
    all_possible_neighbour_indices += [current_num_index - 141 + digit_num for digit_num in range(-1, len(number.group()) + 1)]
    all_possible_neighbour_indices += [current_num_index + 141 + digit_num for digit_num in range(-1, len(number.group()) + 1)]

    for possible_neighbour_index in all_possible_neighbour_indices:
        if 0 < possible_neighbour_index < len(sstring) and sstring[possible_neighbour_index] not in ['\n', '.'] and not sstring[possible_neighbour_index].isdigit():
            existing_neighbours.append(sstring[possible_neighbour_index])

    if existing_neighbours:
        sum_of_part_numbers += int(number.group())
        print(number.group(), existing_neighbours)
...
# for num in part_numbers_list:
#     existing_neighbours = []
#     already_added_flag = 0
#     if num in sstring and part_numbers_list.count(num) == 1:
#         all_possible_neighbour_indices = []
#
#         current_num_index = sstring.index(num)
#         all_possible_neighbour_indices = [current_num_index - 1, current_num_index + len(num), current_num_index - 140, current_num_index - 140 - 1, current_num_index + 140, current_num_index + 140 - 1]
#         all_possible_neighbour_indices += [current_num_index - 140 + digit_num for digit_num in range(1, len(num)+1)]
#         all_possible_neighbour_indices += [current_num_index + 140 + digit_num for digit_num in range(1, len(num)+1)]
#
#         for possible_neighbour in all_possible_neighbour_indices:
#             if 0 < possible_neighbour < len(sstring) and sstring[possible_neighbour] != '\n':
#                 existing_neighbours.append(sstring[possible_neighbour])
#
#         for existing_neighbour in existing_neighbours:
#             if existing_neighbour != '.' and not existing_neighbour.isdigit() and already_added_flag == 0:
#                 sum_of_part_numbers += int(num)
#                 # print(num, "ADDED")
#                 added.append(num)
...
#
#     else:
#         for repeat in re.finditer(num, sstring):
#             existing_neighbours = []
#             already_added_flag = 0
#
#             current_num_index = repeat.start()
#             if not sstring[current_num_index-1].isdigit() and not sstring[current_num_index+len(num)].isdigit():
#                 # print(sstring[current_num_index]+sstring[current_num_index+1]+sstring[current_num_index+2], current_num_index, end = ' ')
#                 all_possible_neighbour_indices = [current_num_index - 1, current_num_index + len(num),current_num_index - 140, current_num_index - 140 - 1,current_num_index + 140, current_num_index + 140 - 1]
#                 all_possible_neighbour_indices += [current_num_index - 140 + digit_num for digit_num in range(1, len(num) + 1)]
#                 all_possible_neighbour_indices += [current_num_index + 140 + digit_num for digit_num in range(1, len(num) + 1)]
#
...
#                     else:
#                         sum_of_part_numbers += 0
#                 previous_num_index = part_numbers_list.index(num)
#                 part_numbers_list.remove(num)
#                 part_numbers_list.insert(previous_num_index, "replaced")
