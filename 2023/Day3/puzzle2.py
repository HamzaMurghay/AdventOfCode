...
sstring = """.679.....662....71............................805..........862.680...................................................................687....
...
sum_of_product_of_gear_ratios = 0

for asterisk in re.finditer('\*', sstring):
    existing_neighbours = set()

    current_num_index = asterisk.start()
    all_possible_neighbour_indices = [current_num_index - 1, current_num_index + len(asterisk.group())]
    all_possible_neighbour_indices += [current_num_index - 141 + digit_num for digit_num in range(-1, len(asterisk.group()) + 1)]
    all_possible_neighbour_indices += [current_num_index + 141 + digit_num for digit_num in range(-1, len(asterisk.group()) + 1)]

    for part_number in re.finditer('\d+', sstring):
        for possible_neighbour_index in all_possible_neighbour_indices:
            if part_number.start()-1 < possible_neighbour_index < part_number.end() and len(existing_neighbours) < 2:
                existing_neighbours.add(int(part_number.group()))

    if len(existing_neighbours) == 2:
        sum_of_product_of_gear_ratios += existing_neighbours.pop() * existing_neighbours.pop()

print("SUM:", sum_of_product_of_gear_ratios)
...
# sstring = """.679.....662....71............................805..........862.680...................................................................687.....
# ............*....-..8141..........846..855......*.............*..$........230.92@............................=.....................92........
# ..........360..........#....664.....=.*...881...677...934.780.......426.*..........8......654.....*959.....539..........21.........*.........
# .....................+.........*......379..*.........*.........=.........969........*........*.976..............872....*....../....579.......
# .......566......652...809....482.394......492..303.650..../...38....%...............106...385..................#.....793..484.865............
# ......*...........*................*..347.......*.........220.....349...691...392*..................18..797.......................+..........
# .....140......890........870.......156............733.................../..........921.....................*......*.............203..........
# .............#...238.....*...........................188......294./58........408...............677.......778....104.903............%.........
# .4141+...828.......*.....706.....249..=.....638...848*...........%...............*948............*.....+......+...........917.......817...346"""  # 43618 AND 5,793,799
